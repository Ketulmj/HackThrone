...
export default function Footer() {
  return (
    <footer className="bg-cyber-dark border-t border-green-900/20 py-8">
      <div className="container px-4 md:px-10">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <h3 className="text-lg font-semibold mb-4 text-green-400">HackThrone</h3>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li className="text-gray-400">info@hackthrone2025.com</li>
        ...
        <div className="border-t border-green-900/20 mt-8 pt-8 text-center text-sm text-gray-400">
          <p>© 2025 HackThrone. All rights reserved.</p>
        </div>
      </div>
    </footer>
  )
